package com.ignite.gestao_vagas.modules.company.controllers;
...
import com.ignite.gestao_vagas.modules.company.dto.CreateJobDTO;
import com.ignite.gestao_vagas.modules.company.entities.JobEntity;
import com.ignite.gestao_vagas.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
  ...
  public JobEntity create(@Valid @RequestBody CreateJobDTO createJobDTO,
    ...
    var jobEntity = JobEntity.builder().benefits(createJobDTO.getBenefits())
        .companyId(UUID.fromString(companyId.toString())).description(createJobDTO.getDescription())
